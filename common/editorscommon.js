...
CTableId.prototype.Read_Class_FromBinary = function(Reader)
{
    ...
    switch( ElementType )
    {
        ...
        case AscDFH.historyitem_type_DocumentContent          : Element = new AscCommon.CDocumentContent(); break;
        ...
        case AscDFH.historyitem_type_Style                    : Element = new AscCommon.CStyle(); break;
